...
const pl: TranslationDict = {
  ...
  home: {
    ...
    featureNarratorTitle: "Jeden spójny narrator",
    featureNarratorBody: "Każdą wycieczkę od początku do końca opowiada ten sam naturalnie brzmiący brytyjski głos.",
    ...
    featureOfflineTitle: "Oszczędza dane",
    featureOfflineBody: "Narracja każdego przystanku ma około 1 MB i wczytuje się po dotarciu, więc zwykłe dane komórkowe w zupełności wystarczą.",
  ...
  map: {
    title: "Odkrywaj w 3D",
    subtitle: "Prawdziwe ulice i budynki w 3D. Przeciągnij, aby się rozejrzeć, a potem wybierz wycieczkę.",
  ...
  account: {
    ...
    storedLocally: "Opcjonalne. Zapisywane tylko na tym telefonie, więc nie synchronizuje się między urządzeniami.",
    ...
    aboutBody: "StoryStep · wersja 1.0.0",

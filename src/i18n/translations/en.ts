const en = {
  ...
  home: {
    ...
    featureNarratorTitle: "One consistent narrator",
    featureNarratorBody: "Every tour is voiced end-to-end by the same natural-sounding British narrator.",
    ...
    featureOfflineTitle: "Light on data",
    featureOfflineBody: "Each stop's narration is about 1 MB and loads as you arrive, so ordinary mobile data is plenty.",
  ...
  map: {
    title: "Explore in 3D",
    subtitle: "Real streets and buildings in 3D. Drag to look around, then pick a tour.",
  ...
  account: {
    ...
    storedLocally: "Optional. Saved on this phone only, so it won't sync between devices.",

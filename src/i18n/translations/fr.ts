...
const fr: TranslationDict = {
  ...
  home: {
    ...
    featureNarratorTitle: "Un seul narrateur",
    featureNarratorBody: "Chaque parcours est raconté de bout en bout par la même voix britannique au ton naturel.",
    ...
    featureOfflineTitle: "Léger en données",
    featureOfflineBody: "La narration de chaque étape pèse environ 1 Mo et se charge à votre arrivée : un forfait mobile ordinaire suffit.",
  ...
  map: {
    ...
    subtitle: "De vraies rues et de vrais bâtiments en 3D. Faites glisser pour explorer, puis choisissez un parcours.",
  ...
  account: {
    ...
    storedLocally: "Facultatif. Enregistré uniquement sur ce téléphone, donc non synchronisé entre appareils.",
    namePlaceholder: "Nom",
    ...
    aboutTitle: "À propos",
    aboutBody: "StoryStep · version 1.0.0",

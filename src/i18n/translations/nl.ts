...
const nl: TranslationDict = {
  ...
  home: {
    ...
    featureNarratorTitle: "Eén vaste verteller",
    featureNarratorBody: "Elke tour wordt van begin tot eind verteld door dezelfde natuurlijk klinkende Britse stem.",
    ...
    featureOfflineTitle: "Zuinig met data",
    featureOfflineBody: "Het verhaal van elke stop is ongeveer 1 MB en laadt zodra je aankomt, dus gewone mobiele data is ruim voldoende.",
  ...
  map: {
    title: "Ontdek in 3D",
    subtitle: "Echte straten en gebouwen in 3D. Sleep om rond te kijken en kies dan een tour.",
  ...
  account: {
    ...
    storedLocally: "Optioneel. Wordt alleen op deze telefoon opgeslagen, dus het synchroniseert niet tussen apparaten.",
    ...
    aboutTitle: "Over",
    aboutBody: "StoryStep · versie 1.0.0",

...
const tr: TranslationDict = {
  ...
  home: {
    ...
    featureNarratorTitle: "Tek bir anlatıcı",
    featureNarratorBody: "Her tur baştan sona aynı doğal sesli İngiliz anlatıcı tarafından seslendirilir.",
    featureScanTitle: "Bir yapıyı tara",
    featureScanBody: "Tanımadığınız bir binaya kamerayı tutun, StoryStep anında tanımayı dener.",
    featureOfflineTitle: "Az veri kullanır",
    featureOfflineBody: "Her durağın anlatımı yaklaşık 1 MB'tır ve vardığınızda yüklenir; normal mobil veri fazlasıyla yeterli.",
  ...
  map: {
    title: "3D'de keşfet",
    subtitle: "Gerçek sokaklar ve binalar 3D olarak. Etrafa bakmak için sürükleyin, sonra bir tur seçin.",
  ...
  account: {
    ...
    storedLocally: "İsteğe bağlı. Yalnızca bu telefonda saklanır, bu yüzden cihazlar arasında eşitlenmez.",
    namePlaceholder: "Ad",
    ...
    aboutTitle: "Hakkında",
    aboutBody: "StoryStep · sürüm 1.0.0",

...
const de: TranslationDict = {
  ...
  home: {
    ...
    featureNarratorTitle: "Eine durchgehende Stimme",
    featureNarratorBody: "Jede Tour wird von Anfang bis Ende von derselben natürlich klingenden britischen Stimme erzählt.",
    ...
    featureOfflineTitle: "Datensparsam",
    featureOfflineBody: "Die Erzählung jeder Station ist etwa 1 MB groß und lädt bei Ihrer Ankunft – normales mobiles Internet reicht völlig.",
  ...
  map: {
    ...
    subtitle: "Echte Straßen und Gebäude in 3D. Zum Umsehen ziehen, dann eine Tour auswählen.",
  ...
  account: {
    ...
    storedLocally: "Optional. Wird nur auf diesem Handy gespeichert und nicht zwischen Geräten synchronisiert.",

...
const zh: TranslationDict = {
  ...
  home: {
    ...
    featureNarratorTitle: "真人讲解，而非机器人",
    featureNarratorBody: "每条行程都由同一位地道的英国配音员从头讲到尾——不是合成语音。",
    featureScanTitle: "扫描地标",
    featureScanBody: "把镜头对准不认识的建筑，StoryStep 会尝试当场为你识别。",
    featureOfflineTitle: "行走途中可离线使用",
    featureOfflineBody: "讲解音频会提前下载，因此桥下信号不好也不会中断。",
    scanCardTitle: "扫描地标",
  ...
  map: {
    title: "3D 探索",
    subtitle: "真实街道、真实建筑——拖动平移，滚动缩放，右键拖动可倾斜视角",
  ...
  account: {
    ...
    storedLocally: "目前信息仅保存在本设备上——尚无服务器，因此不会在手机间同步。",
    namePlaceholder: "姓名",
    emailPlaceholder: "邮箱",
    ...
    aboutTitle: "关于",
    aboutBody: "StoryStep · 版本 1.0.0（原型）",
  ...
  help: {
    ...
    faqs: [
      ...
      {
        q: "锁屏后还能用吗？",
        a: "可以——只要你授予了「始终允许」的定位权限，即使锁屏，后台音频依然会播放，位置更新也会继续触发讲解。",
      },
      {
        q: "全程都需要网络信号吗？",
        a: "不需要。讲解音频会提前下载好，因此在信号不佳的地方也能继续播放——步行途中只需要 GPS 定位。",
      },
      {
        q: "「扫描地标」为什么需要权限？",

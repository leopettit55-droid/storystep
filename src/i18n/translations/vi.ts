...
const vi: TranslationDict = {
  ...
  home: {
    ...
    featureNarratorTitle: "Một người dẫn chuyện xuyên suốt",
    featureNarratorBody: "Mỗi tour đều được thuyết minh từ đầu đến cuối bởi cùng một giọng Anh tự nhiên.",
    ...
    featureOfflineTitle: "Tiết kiệm dữ liệu",
    featureOfflineBody: "Phần thuyết minh mỗi điểm dừng khoảng 1 MB và được tải khi bạn đến nơi, nên dữ liệu di động thông thường là đủ.",
  ...
  map: {
    ...
    subtitle: "Đường phố và tòa nhà thật ở dạng 3D. Kéo để nhìn quanh, rồi chọn một tour.",
  ...
  account: {
    ...
    storedLocally: "Không bắt buộc. Chỉ lưu trên điện thoại này nên sẽ không đồng bộ giữa các thiết bị.",
    namePlaceholder: "Tên",
    ...
    aboutBody: "StoryStep · phiên bản 1.0.0",

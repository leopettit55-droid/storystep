...
const sv: TranslationDict = {
  ...
  home: {
    ...
    featureNarratorTitle: "En och samma berättare",
    featureNarratorBody: "Varje tur berättas från början till slut av samma naturligt klingande brittiska röst.",
    ...
    featureOfflineTitle: "Snål med data",
    featureOfflineBody: "Berättelsen för varje stopp är cirka 1 MB och laddas när du kommer fram, så vanlig mobildata räcker gott.",
  ...
  map: {
    title: "Utforska i 3D",
    subtitle: "Riktiga gator och byggnader i 3D. Dra för att se dig omkring och välj sedan en tur.",
  ...
  account: {
    ...
    storedLocally: "Valfritt. Sparas bara på den här telefonen och synkas inte mellan enheter.",

...
const ko: TranslationDict = {
  ...
  home: {
    ...
    featureNarratorTitle: "한결같은 내레이터",
    featureNarratorBody: "모든 투어는 처음부터 끝까지 같은 자연스러운 영국식 목소리로 진행됩니다.",
    featureScanTitle: "랜드마크 스캔",
    featureScanBody: "잘 모르는 건물에 카메라를 비추면 StoryStep이 즉시 식별을 시도합니다.",
    featureOfflineTitle: "데이터 부담이 적어요",
    featureOfflineBody: "각 정류장의 내레이션은 약 1MB이며 도착할 때 불러오므로 일반 모바일 데이터로 충분합니다.",
  ...
  map: {
    title: "3D로 탐험",
    subtitle: "실제 거리와 건물을 3D로. 드래그해서 둘러본 뒤 투어를 고르세요.",
  ...
  account: {
    ...
    storedLocally: "선택 사항입니다. 이 휴대폰에만 저장되며 다른 기기와 동기화되지 않습니다.",
    namePlaceholder: "이름",

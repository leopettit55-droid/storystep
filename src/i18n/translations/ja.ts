...
const ja: TranslationDict = {
  ...
  home: {
    ...
    featureNarratorTitle: "一貫したナレーター",
    featureNarratorBody: "どのツアーも、最初から最後まで同じ自然な英国のナレーターが語ります。",
    featureScanTitle: "ランドマークをスキャン",
    featureScanBody: "見覚えのない建物にカメラを向けると、StoryStepがその場で識別を試みます。",
    featureOfflineTitle: "データ通信は少なめ",
    featureOfflineBody: "各ストップのナレーションは約1MBで、到着時に読み込まれます。普通のモバイルデータで十分です。",
  ...
  map: {
    title: "3Dで探索",
    subtitle: "本物の街並みと建物を3Dで。ドラッグして見回し、ツアーを選んでください。",
  ...
  account: {
    ...
    storedLocally: "任意です。この端末にのみ保存され、他の端末とは同期されません。",
    namePlaceholder: "名前",
    ...
    aboutTitle: "アプリについて",
    aboutBody: "StoryStep · バージョン 1.0.0",
  ...
  help: {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "歩いている間は画面をオンにしておいてください。スマートフォンがロックされているとブラウザは位置情報の更新を一時停止するため、ロックを解除するまで次のストップは始まりません。",
      },
      {
        q: "散歩の間ずっと通信は必要ですか？",
        a: "はい、モバイルデータが必要です。各ストップのナレーションはそこに着いた時点で読み込まれます（1ストップあたり約1MB）。電波が弱いと、再生開始が数秒遅れることがあります。",
      },
      {

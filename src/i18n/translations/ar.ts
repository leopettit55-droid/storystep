  ...
  help: {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "نعم — يستمر تشغيل الصوت في الخلفية وتستمر تحديثات الموقع في تشغيل المقاطع حتى مع إطفاء الشاشة، طالما منحت إذن الموقع \"دائمًا\".",
      },
      {
        q: "هل أحتاج إلى إشارة طوال المشي؟",
        a: "لا. يتم تنزيل ملفات السرد الصوتية مسبقًا، لذا تستمر في العمل حتى مع اتصال ضعيف — لا يلزم سوى GPS أثناء المشي.",
      },
      {

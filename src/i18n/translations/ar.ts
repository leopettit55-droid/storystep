...
const ar: TranslationDict = {
  ...
  home: {
    ...
    featureNarratorTitle: "راوٍ واحد متناسق",
    featureNarratorBody: "كل جولة يرويها من البداية إلى النهاية الصوت البريطاني الطبيعي نفسه.",
    featureScanTitle: "امسح معلمًا",
    featureScanBody: "وجّه كاميرتك نحو مبنى لا تعرفه وسيحاول StoryStep التعرف عليه فورًا.",
    featureOfflineTitle: "استهلاك قليل للبيانات",
    featureOfflineBody: "سرد كل محطة نحو 1 ميغابايت ويُحمَّل عند وصولك، لذا تكفي بيانات الجوال العادية.",
  ...
  map: {
    ...
    subtitle: "شوارع ومبانٍ حقيقية بتقنية ثلاثية الأبعاد. اسحب لتستكشف، ثم اختر جولة.",
  ...
  account: {
    ...
    storedLocally: "اختياري. يُحفظ على هذا الهاتف فقط، لذا لن تتم مزامنته بين الأجهزة.",
    ...
    aboutBody: "StoryStep · الإصدار 1.0.0",

...
const id: TranslationDict = {
  ...
  home: {
    ...
    featureNarratorTitle: "Satu narator yang konsisten",
    featureNarratorBody: "Setiap tur dinarasikan dari awal hingga akhir oleh suara Inggris yang sama dan terdengar alami.",
    ...
    featureOfflineTitle: "Hemat data",
    featureOfflineBody: "Narasi setiap perhentian sekitar 1 MB dan dimuat saat Anda tiba, jadi data seluler biasa sudah cukup.",
  ...
  map: {
    ...
    subtitle: "Jalan dan bangunan nyata dalam 3D. Geser untuk melihat-lihat, lalu pilih tur.",
  ...
  account: {
    ...
    storedLocally: "Opsional. Hanya disimpan di ponsel ini, jadi tidak tersinkron antarperangkat.",
    ...
    aboutTitle: "Tentang",
    aboutBody: "StoryStep · versi 1.0.0",

...
const es: TranslationDict = {
  ...
  home: {
    ...
    featureNarratorTitle: "Un narrador real, no un robot",
    featureNarratorBody: "Cada recorrido está narrado de principio a fin por una sola voz británica natural — no es texto a voz sintetizado.",
    ...
    featureOfflineTitle: "Funciona sin conexión durante el paseo",
    featureOfflineBody: "El audio de la narración se descarga por adelantado, así que una conexión débil bajo un puente no te dejará sin sonido.",
  ...
  map: {
    ...
    subtitle: "Calles y edificios reales — arrastra para moverte, desplázate para hacer zoom, arrastra con clic derecho para inclinar",
  ...
  account: {
    ...
    storedLocally: "Por ahora solo se guarda en este dispositivo — todavía no hay servidor, así que no se sincroniza entre teléfonos.",
    ...
    aboutBody: "StoryStep · versión 1.0.0 (prototipo)",
  ...
  tourPreview: {
    ...
    scannerFree: "Gratis: no hace falta comprar el tour",

...
const pt: TranslationDict = {
  ...
  home: {
    ...
    featureNarratorTitle: "Um narrador do início ao fim",
    featureNarratorBody: "Cada passeio é narrado do início ao fim pela mesma voz britânica de som natural.",
    ...
    featureOfflineTitle: "Poupa dados",
    featureOfflineBody: "A narração de cada paragem tem cerca de 1 MB e é carregada quando chega, por isso os dados móveis normais chegam.",
  ...
  map: {
    ...
    subtitle: "Ruas e edifícios reais em 3D. Arraste para explorar e depois escolha um passeio.",
  ...
  account: {
    ...
    storedLocally: "Opcional. Fica guardado apenas neste telemóvel, por isso não sincroniza entre dispositivos.",
    ...
    aboutTitle: "Sobre",
    aboutBody: "StoryStep · versão 1.0.0",

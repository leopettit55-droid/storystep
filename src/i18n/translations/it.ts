...
const it: TranslationDict = {
  ...
  home: {
    ...
    featureNarratorTitle: "Un'unica voce narrante",
    featureNarratorBody: "Ogni tour è narrato dall'inizio alla fine dalla stessa voce britannica dal suono naturale.",
    ...
    featureOfflineTitle: "Leggero sui dati",
    featureOfflineBody: "La narrazione di ogni tappa pesa circa 1 MB e si carica quando arrivi, quindi bastano i normali dati mobili.",
  ...
  map: {
    title: "Esplora in 3D",
    subtitle: "Strade ed edifici reali in 3D. Trascina per guardarti intorno, poi scegli un tour.",
  ...
  account: {
    ...
    storedLocally: "Facoltativo. Viene salvato solo su questo telefono, quindi non si sincronizza tra dispositivi.",
    ...
    aboutBody: "StoryStep · versione 1.0.0",
